...
public class Main {
	...
	/**
	 * TODO DELETE THIS HUGE STRING MONSTER!? Use a file for the default icon, or don't use a default icon at
	 * all.
	 */
	private static final String DEFAULT_ICON = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAEAAAABACAIAAAAlC+aJAAAAAXNSR0IArs4c"
