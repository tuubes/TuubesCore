...
final case class ReplaceBlocks(replace: Array[BlockType],
							   replacements: Array[BlockType]) extends AreaMessage

final case class ReplaceBlocksAdvanced(fromX: Int, fromY: Int, fromZ: Int,
...
final case class FillBlocksAdvanced(fromX: Int, fromY: Int, fromZ: Int,
									toX: Int, toY: Int, toZ: Int,
									fillWith: BlockType,
									exceptions: Array[BlockType]) extends AreaMessage {
